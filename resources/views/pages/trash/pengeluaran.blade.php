@extends('partials.master', [$titlePage = 'Sampah', $activePage = 'trash', $miniMenu = 'pengeluaran'])
@section('content')
{{-- =============================================================== --}}
{{-- ========================        Outlet     =================== --}}
{{-- =============================================================== --}}
<div class="card">
    <div class="card-body">
        <h3 class="mb-3">Sampah Pengeluaran</h3>
        <div class="form-row">
            <div class="col-md-8 mt-3">
                <a href="javascript:void(0)" class="btn btn-sm btn-info btn-restore-all-paket" data-url="{{ route('pengeluaran.softDelete.all') }}">Kembalikan</a>
                <a href="javascript:void(0)" class="ml-1 btn btn-sm btn-danger btn-delete-all-paket" data-url="{{ route('pengeluaran.softDelete.all') }}">Hapus</a>
...
<script>
    ...
    let table = $('#tablePengeluaran').DataTable({
        ...
        ajax: "{{ route('pengeluaran.softDelete.data') }}",
        columns: [

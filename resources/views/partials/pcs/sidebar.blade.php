            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    ...
                    <li class="sidebar-item {{ $activePage == 'dashboard' ? 'selected' : '' }}"> <a class="sidebar-link sidebar-link" href="index.html"
                        ...
                        <li class="sidebar-item {{ $activePage == 'produk' ? 'selected' : '' }}"> <a class="sidebar-link sidebar-link" href="/produk"
                                aria-expanded="false"><i class="fas fa-shopping-cart"></i><span
                                    class="hide-menu">Produk
                                </span></a>
                        </li>
                        <li class="sidebar-item {{ $activePage == 'pengguna' ? 'selected' : '' }}"> <a class="sidebar-link sidebar-link" href="/pengguna"
                        ...
                        <li class="sidebar-item {{ $activePage == 'laporan' ? 'selected' : '' }}"> <a class="sidebar-link sidebar-link" href="/laporan"
                                aria-expanded="false"><i class="far fa-file-archive"></i><span
